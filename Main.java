...
public class Main{
    public static void main(String[] args){
        JFrame main_frame = new JFrame("Exercise 1 - Is your number an integer?"); // make window
        main_frame.setSize(1000, 500); // set default size of window

        JLabel correct_input = new JLabel("It is an integer!");
        correct_input.setBounds(10, 10, 300, 25);
        correct_input.setBackground(Color.CYAN);
        correct_input.setOpaque(true);
        main_frame.add(correct_input);
        correct_input.setVisible(false);

        JLabel invalid_input = new JLabel("Not an integer - try again.");
        invalid_input.setBounds(10, 10, 300, 25);
        invalid_input.setBackground(Color.CYAN);
        ...
        verify_button.setBounds(200, 200, 100, 60); // x-coord, y-coord, width, height
        ...
        exit_button.setBounds(700, 200, 100, 60);
